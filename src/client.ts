...
/**
 * Client plugin for the inbox endpoints.
 *
 * `$InferServerPlugin` carries the server plugin's types across, so the generated
 * methods are typed from the endpoint definitions rather than restated here.
 *
