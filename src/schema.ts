...
export const schema = {
	...
	mailkiteMessage: {
		fields: {
			...
			/**
			 * "inbound" for mail we received, "outbound" for a reply we sent.
			 *
			 * Replies used to be sent and forgotten, so a conversation showed the other
			 * party's messages and none of your own — the thread read as though you had
			 * never answered.
			 */
			direction: {
				type: "string",
